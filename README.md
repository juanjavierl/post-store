...
en windows lo realise de esta manera:
ingrese al cms con en entorno virtual activado, ingrese el shell
ahi ejecute: from core.init import *
de esta manera migre los datos
```
