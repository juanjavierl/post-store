...
class Product(models.Model):
    ...
    def porcentage(self):
        total = (self.price_before - self.pvp)/self.pvp * 100
        return int(total)
...
class Banco(models.Model):
    ...
    cuenta = models.CharField(max_length=50, verbose_name='Nro. de cuanta')
    qr_img = models.ImageField(null=True, blank=True, upload_to='img_qr', verbose_name='Img QR de pago')
    compania = models.ForeignKey(Company, on_delete=models.PROTECT, verbose_name='Negocio')
    class Meta:
...
class Client(models.Model):
    ...
    birthdate = models.DateField(default=datetime.now, verbose_name='Fecha de registro')
    address = models.CharField(max_length=500, null=True, blank=True, verbose_name='Dirección* (Ingrese:Calle,Nro,Zona)')
